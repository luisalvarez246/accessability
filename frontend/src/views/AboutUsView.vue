<template>
  <v-container fluid max-width="1140" class="pt-0 mx-auto">
    <v-container
      height="auto"
      width="100%"
      class="hero_section d-flex justify-center pb-0 mb-0"
      color="mainbackground"
      rounded="lg"
    >
      <v-img
        lazy-src="../assets/images/aboutus.avif"
    ...
    <v-container class="pt-0">
      <v-card
        class="team_members mx-auto mb-8"
        max-width="1140"
        ...
        <v-row justify="center">
          <v-col cols="12" xs="12" sm="12" md="12" lg="8" xl="8">
            <v-row>
              ...
              >
                <v-card-item
                  class="team_members_item text-center justify-center align-center"
                  color="cardbackground1"
                >
                  <v-img
                    :lazy-src="author.photo"
                    :src="author.photo"
      ...
      <v-card class="mt-4 mx-auto" max-width="1140" color="cardbackground1">
        ...
        <v-divider></v-divider>
        <v-sheet
          class="mx-auto mb-10 px-10"
          width="90%"
          color="cardbackground2"
        >
          <div class="mx-auto pt-3">
            <v-form
              action="https://formspree.io/f/mwkdarwd"
              method="POST"
              ref="form"
              role="form"
              class="pt-4"
            ...
            <v-card-actions
              class="w-100 d-flex justify-center flex-sm-row flex-column"
            >
              <v-btn
                class="reset_btn text-none mb-4 px-6 mx-auto mx-sm-10"
                @click="cancel"
                :size="xs ? '' : 'x-large'"
                :height="xs ? 52 : ''"
                :class="{ 'text-h6': xs }"
              ...
              <v-btn
                class="submit_btn mb-4 text-none px-6 mx-auto mx-sm-10"
